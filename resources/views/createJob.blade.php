...
>>>>>>> parent of 94ddf99 (added profile image)
        ...
        <div class="mb-6">
          <label for="salaryrange" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Salary Range</label>
          <input type="text" name="salaryrange"  id="salaryrange" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
        </div>
        <input type="hidden"  name="companyname" value="{{Session::get("name")}}"/>
