                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    ...
                    <div>
                        <label for="courses" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an option</label>
                            <select id="courses" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected>Choose a course.</option>
                            <option value="IT">Information Technology & Software Developement</option>
                            <option value="CA">Law</option>
                            <option value="FR">Journalism</option>
                            <option value="DE">Medicine</option>
                        </select>
                    </div>
                    <div>
